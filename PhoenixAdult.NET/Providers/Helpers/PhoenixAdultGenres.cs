...
{
    public static class PhoenixAdultNETGenres
    {
        public static List<string> Cleanup(List<string> genresLink, string sceneName)
        {
            ...
            foreach (var genreLink in genresLink)
            {
                ...
                {
                    genreName = PhoenixAdultNETProvider.Lang.TextInfo.ToTitleCase(genreName);
            ...
            return newGenres.OrderBy(item => item).ToList();
        }
