...
namespace PhoenixAdultNET.Providers.Helpers
{
    class PhoenixAdultNETHelper
    {
        public static string GetSearchSiteName(int[] siteNum)
        {
            ...
            return PhoenixAdultNETList.SiteList[siteNum[0]][siteNum[1]][0];
        }
        ...
        public static string GetSearchBaseURL(int[] siteNum)
        {
            ...
            if (!string.IsNullOrEmpty(PhoenixAdultNETList.SiteList[siteNum[0]][siteNum[1]].ElementAtOrDefault(1)))
                return PhoenixAdultNETList.SiteList[siteNum[0]][siteNum[1]][1];
            else
                return PhoenixAdultNETList.SiteList[siteNum[0]].First().Value[1];
        }
        ...
        public static string GetSearchSearchURL(int[] siteNum)
        {
            ...
            if (!string.IsNullOrEmpty(PhoenixAdultNETList.SiteList[siteNum[0]][siteNum[1]].ElementAtOrDefault(2)))
                return PhoenixAdultNETList.SiteList[siteNum[0]][siteNum[1]][2];
            else
                return PhoenixAdultNETList.SiteList[siteNum[0]].First().Value[2];
        }
